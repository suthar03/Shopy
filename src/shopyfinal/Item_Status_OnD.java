...
public class Item_Status_OnD extends javax.swing.JFrame {

    String baseadd, logo, user, ITMadd, ndt, dt, lang = "English";
    String IDyear = "2020-2020", Syear = "01/01/2020", Eyear = "01/01/2020";

    public Item_Status_OnD(String base, String golo, String gh, String idy, String sy, String ey) {
        ...
        //System.out.println("Now cheching for status");
        ITMadd = baseadd + "/" + user + "/" + IDyear + "/item";
        initComponents();
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(50, 50, 902, (int) dim.getHeight() - 40);
    ...
    public void stocker() {
        ...
        try {
            ...
            while (read.hasNext()) // It's for Item ... equals to the number of item
            {
                ...
                if (lang.compareToIgnoreCase("English") != 0) {
                    model.addRow(new Object[]{table.getRowCount() + 1, icode, iHname, String.format("%.1f", TotalITMOnDS), String.format("%.1f", TotalITMOnDB), String.format("%.1f", CStatus)});
                } else {
                    model.addRow(new Object[]{table.getRowCount() + 1, icode, iEname, String.format("%.1f", TotalITMOnDS), String.format("%.1f", TotalITMOnDB), String.format("%.1f", CStatus)});
                }
//TextIO.putln(ccode +"  ---> "+CStatus);
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial No.", "Code", "Name", "Selled", "Buyed", "Final Stock"
            }
        ) {
        ...
        Headinglbl.setText("Item Status up to :");
        Headinglbl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                HeadinglblMouseClicked(evt);
            }
        });

        dtlbl.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        dtlbl.setForeground(new java.awt.Color(102, 102, 255));
        ...
        print.setFont(new java.awt.Font("Tahoma", 1, 21)); // NOI18N
        print.setText("Print");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Headinglbl, javax.swing.GroupLayout.DEFAULT_SIZE, 877, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
...
//######################################################################################3
    ...
    private void HeadinglblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_HeadinglblMouseClicked

    }//GEN-LAST:event_HeadinglblMouseClicked

    private void dtlblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dtlblMouseClicked
        daty(); // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Item_Status_OnD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Item_Status_OnD().setVisible(true);
            }
        });
    }
