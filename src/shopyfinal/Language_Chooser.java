 ...
 * @author Suthar
 */
public class Language_Chooser extends javax.swing.JFrame {

    /**
     * Creates new form Language_Chooser
     */
    ...
    public Language_Chooser(String base,String golo) {
        baseadd=base;
        logo=golo;
        try {
            this.setIconImage(ImageIO.read(new File(logo)));
        } catch (IOException ex) {
            Logger.getLogger(Language_Chooser.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Language_Chooser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Language_Chooser().setVisible(true);
            }
        });
    }
