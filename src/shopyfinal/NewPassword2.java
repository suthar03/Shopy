 ...
 * @author Suthar
 */
public class NewPassword2 extends javax.swing.JFrame {
...
if(a==10)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewPassword2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
