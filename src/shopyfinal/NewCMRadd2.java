 ...
 * @author Suthar
 */
public class NewCMRadd2 extends javax.swing.JFrame {

    String sd;
 String baseadd,logo ,user,CMRadd,lang="English";
 String IDyear="2020-2020",Syear="01/01/2020",Eyear="01/01/2020";
    
    //##################################################################
    public NewCMRadd2(String base,String golo,String idy, String sy,String ey) {
       baseadd=base;
       logo=golo;
       IDyear = idy;
        Syear = sy;
...
if(yon==0){//YES    
            ...
            //System.out.print("confirmActionPerformed");
                ...
                String sbal= String.valueOf(-1*(Float.valueOf(pbal.getText())));
                     ...
                     if(repeatation.mainn(CMRadd, "customer.txt", scode)==0){
                try {                //set customer account to customer.txt

                   PrintWriter out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(CMRadd+ "/customer.txt", true), "UTF-8"));
                    out.println(scode);
                    out.close();
                } catch (IOException ex) {
                    JLabel label = new JLabel("customer.txt Problem !!! Error00071");
            label.setFont(new Font("Arial", Font.BOLD, 18));
            JOptionPane.showMessageDialog(null,label,"ERROR",JOptionPane.WARNING_MESSAGE);
       
                }

                     dirCreate.mainn(CMRadd, scode);
                     final String Acadd = CMRadd+"/"+scode;
...
BufferedWriter writ=Files.newBufferedWriter(Paths.get(Acadd+"/profile.txt"), StandardCharsets.UTF_8,StandardOpenOption.APPEND,StandardOpenOption.CREATE)
                   ...
                   out.println(smob);
                   out.println(sadd);
                   out.println(String.valueOf(-1*(Float.valueOf(sbal))));
                   out.println(sd);
                   */
            ...
            JOptionPane.showMessageDialog(null,label,"ERROR",JOptionPane.WARNING_MESSAGE);
                      ...
                      try {                try ( //set customer intial balance to customer.txt
                     // PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(CMRadd+"/"+scode+"/Pending/Given/"+NamingDateName.mainn(sd)+ ".txt"))) // Detail stord in formate of name \n code \n add \n mob
                      PrintWriter out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(CMRadd+"/"+scode+"/Pending/Given/"+NamingDateName.mainn(sd)+ ".txt"), "UTF-8"));        
                      ) {
                      out.println(sbal);
                      out.println("0000.00");
            ...
            JOptionPane.showMessageDialog(null,label,"ERROR",JOptionPane.WARNING_MESSAGE);
                ...
                pmob.setForeground(Color.pink);
                pcode.requestFocus();
               MessageOnTimeOfSuccess.mainn("Customer Account Added Successfully");
...
char c = evt.getKeyChar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            JLabel label = new JLabel("There is problem in NewCMRadd !!! Error0003");
            label.setFont(new Font("Arial", Font.BOLD, 18));
            JOptionPane.showMessageDialog(null,label,"ERROR",JOptionPane.WARNING_MESSAGE);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(NewCMRadd2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
