...
public class Item_Add extends javax.swing.JFrame {
    ...
    public Item_Add(String base, String golo, String idy, String sy, String ey) {
...
String sEname, sHname, sprice, scode, sstock, sd, minreq;
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (yon == 0 && (!pcode.getText().isEmpty())) {//YES    
            ...
            sstock = istk.getText();
            minreq = min.getText();
            if (ShortFunction.repeatationWOcase(ITMadd, "item.txt", scode) == 0) {
                try {
                    PrintWriter out;
                ...
                ShortFunction.CreateDir(ITMadd, scode);
                final String Acadd = ITMadd + "/" + scode;
                ShortFunction.CreateDir(Acadd, "Status");
...
//Setting of defaults over
                ...
                PrintWriter out;
                try {
                    out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(ITMadd + "/" + scode + "/status/" + ShortFunction.NamingDateName(sd) + ".txt", true), "UTF-8"));
                    //out = new PrintWriter(new BufferedWriter(new FileWriter(ITMadd + "/" + scode + "/status/" + ShortFunction.NamingDateName(sd) + ".txt", true))); // Detail stord in formate of name \n code \n price \n mob
                    out.println(sstock);
                    out.println("00.0");
                    out.close();
                } catch (IOException ex) {
