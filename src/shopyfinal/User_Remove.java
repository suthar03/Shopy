 ...
 * @author Suthar
 */
public class User_Remove extends javax.swing.JFrame {

    String baseadd, logo, user;

    public User_Remove(String base, String golo) {
        baseadd = base;
        logo = golo;
        initComponents();
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (yon == 0) {//YES
            int u = ShortFunction.repeatation(baseadd, "userID.txt", usr.getText());
            ...
            if (u == 1) {       //user is existing
                ...
                try {
                    ...
                    String pswdorg = ShortFunction.GetPassword(baseadd, usr.getText());
                    if (data.equals(pswdorg)) {        //Password is also correct
                        ...
                        ShortFunction.RemoveLine(baseadd, "userID.txt", usr.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Remove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new User_Remove().setVisible(true);
            }
        });
    }
