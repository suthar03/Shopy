 ...
 * @author Suthar
 */
public class ITMxStatusOnD2D extends javax.swing.JFrame {
    ...
    public ITMxStatusOnD2D(String base,String golo,String sd1 ,String sd2,String idy, String sy,String ey) {
         baseadd=base;
         logo=golo;
         IDyear = idy;
        Syear = sy;
...
dm.fireTableDataChanged(); 
      ...
      Scanner inread ;
       ...
       String dsd;
        for(dsd=NamingDate.mainn(dt1);DateInBetween.mainn(SSyear, dsd, dsd);dsd=datem15.mainn(dsd)) { 
...
daty();        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ITMxStatusOnD2D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new ITMxStatusOnD2D().setVisible(true);
            }
        });
    }
