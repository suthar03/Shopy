...
public class User_Password_Change extends javax.swing.JFrame {

    String baseadd, logo, lang = "English";
    String user;

    public User_Password_Change(String base, String golo, String usrr) {
        baseadd = base;
        logo = golo;
        user = usrr;
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Password_Change.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new User_Password_Change().setVisible(true);
            }
        });
    }
