 ...
 * @author Suthar
 */
public class PRTxBillingNewMono2 extends javax.swing.JFrame {
String baseadd="D:/Shopy/Shopy",logo="src/Icons/logo.png",PRTadd,ITMadd,user,sd1,sd2,sd,cd,cd1,cd2,lang="English";
     ...
     */
    public PRTxBillingNewMono2(String add,String golo,String idy, String sy,String ey) {
        baseadd=add;
        logo=golo;
        IDyear = idy;
        Syear = sy;
...
{   
    ...
    if(repeatation.mainn(PRTadd,"party.txt" ,cd)==1){
...
//#######################################################################################################################################
      ...
      for(;DateInBetween.mainn(DtAdd, dsd, sd1);dsd=datem15.mainn(dsd)){
          tmp1=new File(PRTadd + "/"+pcode+"/Pending/Given/"+NamingDateName.mainn(dsd)+".txt");
          bg = tmp1.exists();
          if(bg){
...
char c = evt.getKeyChar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRTxBillingNewMono2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRTxBillingNewMono2("D:/Shopy/Shopy","src/Icons/logo.png","2020-2021","10/01/2020","31/12/2020").setVisible(true);
            }
        });
    }
