 ...
 * @author Suthar
 */
public class NewITMlist extends javax.swing.JFrame {

    String baseadd,logo,user, ITMadd;
    String IDyear="2020-2020",Syear="01/01/2020",Eyear="01/01/2020";
    public NewITMlist(String base,String golo ,String idy, String sy,String ey) {
        baseadd=base;
        logo=golo;
        IDyear = idy;
        Syear = sy;
    ...
    setBounds(50, 50, 770, (int) dim.getHeight()-50);
  ...
  while (read.hasNext())
{
   ...
   model.addRow(new Object[]{listTable.getRowCount()+1,code,Ename,Hname,rate});
   //TextIO.putln(i);
   inread.close();
            } catch (FileNotFoundException ex) {
                Logger.getLogger(NewITMlist.class.getName()).log(Level.SEVERE, null, ex);
            }
...
read.close();
    ...
    private void initComponents() {
        ...
        setTitle("Listing All Items");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("List Of All Item");

        listTable.setFont(new java.awt.Font("Monospaced", 1, 16)); // NOI18N
        listTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Serial No.", "Code", "Name(in English)", "Name(in Hindi)", "Rate"
            }
        ) {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(src, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
...
int i=0;
    private void srcKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_srcKeyReleased
        // TODO add your handling code here:
        final DefaultTableModel model = (DefaultTableModel)listTable.getModel();
        final TableModel tm = listTable.getModel();
           int t=listTable.getRowCount();
           
//listTable.scrollRectToVisible(null);
           ...
           //System.out.println("RowCount:"+t);
                ...
                if(k==10){
                    ...
                    if(n.contains(tb))
                    {
                        ...
                        listTable.setRowSelectionInterval(i, i);
                             listTable.getSelectionModel().setSelectionInterval(i, i);
                             listTable.scrollRectToVisible(new Rectangle(listTable.getCellRect(i+5, 0, true)));
                        break;
                    //listTable.selectAll();
                    }else{
                        String m = (String)tm.getValueAt(i, 2);
                        m=m.toUpperCase();
                        ...
                        c=c.toUpperCase();
                            if(c.contains(tb)){       //mobile no
                             ...
                             break;
                               ...
                               String hn = (String)tm.getValueAt(i, 3);
                        hn=hn.toUpperCase();
                            if(hn.contains(tb)){       //mobile no
                             listTable.setRowSelectionInterval(i, i); 
                             listTable.getSelectionModel().setSelectionInterval(i, i);
                             listTable.scrollRectToVisible(new Rectangle(listTable.getCellRect(i+5, 0, true)));
                             break;
                                ...
                                listTable.clearSelection();
                                //System.out.println("nulli:"+listTable.getSelectedRow());
                                //src.requestFocus();
                                //listTable.setRowSelectionInterval(3, 3);
                            }
                            }
                        }
                    }
           ...
           listTable.getSelectionModel().setSelectionInterval(0, 0);
listTable.scrollRectToVisible(new Rectangle(listTable.getCellRect(0, 0, true)));
listTable.clearSelection();
                    }
                } 
                else{
...
listTable.scrollRectToVisible(new Rectangle(listTable.getCellRect(0, 0, true)));
                ...
                for( ++i;i<t;++i){
                    ...
                    //listTable.selectAll();
                        ...
                        String m = (String)tm.getValueAt(i, 3);
                        m=m.toUpperCase();
                        if(m.contains(tb)){       //code
                            listTable.setRowSelectionInterval(i, i);
                             listTable.getSelectionModel().setSelectionInterval(i, i);
...
listTable.clearSelection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewITMlist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new NewITMlist().setVisible(true);
            }
        });
    }
