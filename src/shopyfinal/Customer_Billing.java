...
public class Customer_Billing extends javax.swing.JFrame {
     ...
     */
    public Customer_Billing(String add, String golo, String idy, String sy, String ey) {
        baseadd = add;
        logo = golo;
        IDyear = idy;
        Syear = sy;
    ...
    public void Biller() {
        ...
        try {
            ...
            while (Integer.valueOf(cd) <= Integer.valueOf(cd2)) // It's for user ... equals to the number of user
            {
                ...
                if (ShortFunction.repeatation(CMRadd, "customer.txt", cd) == 1) {
...
//#######################################################################################################################################
                    ...
                    if (ShortFunction.DateInBetween(DtAdd, dsd, sd1)) {
                        for (; ShortFunction.DateInBetween(DtAdd, dsd, sd1); dsd = ShortFunction.Date_minus(dsd)) {
                            tmp1 = new File(CMRadd + "/" + pcode + "/Pending/Given/" + ShortFunction.NamingDateName(dsd) + ".txt");
                            bg = tmp1.exists();
                            if (bg) {
...
//Graphics2D g3d = (Graphics2D) graphics;  
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customer_Billing("D:/Shopy/Shopy", "src/Icons/logo.png", "2020-2021", "10/01/2020", "31/12/2020").setVisible(true);
            }
        });
    }
