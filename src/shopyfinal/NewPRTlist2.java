 ...
 * @author Suthar
 */
public class NewPRTlist2 extends javax.swing.JFrame {
   ...
   String IDyear="2020-2020",Syear="01/01/2020",Eyear="01/01/2020";
    ...
    public NewPRTlist2(String base,String golo, String idy, String sy,String ey) {
        ...
        try {
            ...
            JLabel label = new JLabel("Error in replacement !!! Error0014");
    ...
    private void initComponents() {
        ...
        setTitle("Listing All Party");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("List of All Party");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial No.", "Code", "Name(in English)", "Name(in Hindi)", "Contact", "Address"
            }
        ) {
        ...
        table.setName("Listing All Customer(s)"); // NOI18N
        ...
        top.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        top.setText("Search Bar:>");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(src, javax.swing.GroupLayout.PREFERRED_SIZE, 228, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(21, 21, 21))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1031, Short.MAX_VALUE)
...
dm.fireTableDataChanged(); 
        Scanner read ;
            ...
            read = new Scanner(new File(PRTadd+"/party.txt"),"UTF-8");
  ...
  while (read.hasNext())
{
      ...
      if(Integer.valueOf(Pacc)>maxx){
          
          maxx=Integer.valueOf(Pacc);
      }
}
            }catch (FileNotFoundException ex) {
            JLabel label = new JLabel("Party list file error !!! Error0017");
...
String code, Ename,Hname, mob,add;
  while (cd<=maxx)
{
    
    
    String Pacc =String.format("%04d", cd);
    
    if(repeatation.mainn(PRTadd,"party.txt", Pacc)==1){
      
      
        Scanner inread ;
        inread = new Scanner(new File(PRTadd+"/"+Pacc+"/profile.txt"), "UTF-8");
        inread.useDelimiter("\\n");
        ...
        mob = inread.nextLine();
        add = inread.nextLine();
        model.addRow(new Object[]{table.getRowCount()+1,code,Ename,Hname,mob,add});
        inread.close();
           ...
           int t=table.getRowCount();
                ...
                tb=src.getText();
                    ...
                    if(!tb.isEmpty()){
                        ...
                        System.out.println("Key realkrlkfn ");
                if(k==10){
                    i=table.getSelectedRow();
                    tb=tb.toUpperCase();
                    System.out.println(tb);
                    for( ++i;i<t;++i){
                    String mn = (String)tm.getValueAt(i, 4);
                        ...
                        c=c.toUpperCase();
                            if(c.contains(tb)){       //code
                             ...
                             break;
                                ...
                                String hc = (String)tm.getValueAt(i, 5);
                        hc=hc.toUpperCase();
                        System.out.println("HC: "+hc);
                        System.out.println("tb: "+tb);
                        
                            if(hc.contains(tb)){       //mobile no
                             table.setRowSelectionInterval(i, i); 
                             table.getSelectionModel().setSelectionInterval(i, i);
                             table.scrollRectToVisible(new Rectangle(table.getCellRect(i+5, 0, true)));
                             break;
                        ...
                        c=c.toUpperCase();
                            if(c.contains(tb)){       //mobile no
                             ...
                             break;
                                ...
                                String hc = (String)tm.getValueAt(i, 4);
                        hc=hc.toUpperCase();
                            if(hc.contains(tb)){       //mobile no
                             table.setRowSelectionInterval(i, i);
                             table.getSelectionModel().setSelectionInterval(i, i);
...
table.clearSelection();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(NewPRTlist2.class.getName()).log(Level.SEVERE, null, ex);
        }
MessageFormat header = new MessageFormat("kanti कान्ति ");
        try{
         ...
         try{
           ...
           pgi=pageIndex;
            ...
            TableModel tm = table.getModel();  
              //System.out.println("Getted value :"+lineno(pageIndex));
            int kk=pageIndex*nol,end=(pageIndex+1)*nol;
            if(end>tm.getRowCount()) end = tm.getRowCount();
             for(;kk<end;++kk){
                 Object o = tm.getValueAt(kk, 0);
                 String sr=(String)o;
                 o = tm.getValueAt(kk, 0);
                 ...
                 g2d.drawString(sr,10,y);y+=yShift;
            ...
            g2d.drawString("*************************************",10,y);y+=yShift+20;
...
public PageFormat getPageFormat(PrinterJob pj)
{
    ...
    pf = pj.defaultPage();
    paper = pf.getPaper();    
    double middleHeight =10*(100);
    //double headerHeight = 2.0;                  
    //double footerHeight = 3.0;                  
    double width = convert_CM_To_PPI(8);      //printer know only point per inch.default value is 72ppi
    double height = 50+middleHeight;//convert_CM_To_PPI(headerHeight+middleHeight+footerHeight); 
    System.out.println("Setted height"+height);
...
protected static double toPPI(double inch) {            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewPRTlist2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewPRTlist2("D:/Shopy/Shopy","src/Icons/logo.png","20210128-20210630","28/01/2021","30/06/2021").setVisible(true);
            }
        });
    }
