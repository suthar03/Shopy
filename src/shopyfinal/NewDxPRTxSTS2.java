 ...
 * @author Suthar
 */
public class NewDxPRTxSTS2 extends javax.swing.JFrame {

    String baseadd,logo,user,lang="English";
    String IDyear="2020-2020",Syear="01/01/2020",Eyear="01/01/2020";
    public NewDxPRTxSTS2(String base,String golo ,String idy, String sy,String ey) {
        baseadd=base;
        logo=golo;
        IDyear = idy;
        Syear = sy;
...
new NewPRTxCASHxSTS2(baseadd,logo,sd,IDyear,Syear,Eyear).setVisible(true);
this.dispose();
...
if(evt.getKeyCode()==KeyEvent.VK_ENTER)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewDxPRTxSTS2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
