...
public class Supplier_Add extends javax.swing.JFrame {
    ...
    //##################################################################
    public Supplier_Add(String base, String golo, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (yon == 0) {//YES    
            ...
            if (ShortFunction.repeatation(PRTadd, "party.txt", scode) == 0) {
                ...
                ShortFunction.CreateDir(PRTadd, scode);
                final String Acadd = PRTadd + "/" + scode;
                ShortFunction.CreateDir(Acadd, "Pending");
                ShortFunction.CreateDir(Acadd, "Cash");
                String Pdadd = Acadd + "/Pending";
                ShortFunction.CreateDir(Pdadd, "Given");
                ShortFunction.CreateDir(Pdadd, "Taken");
                String Csadd = Acadd + "/Cash";
                ShortFunction.CreateDir(Csadd, "Given");
                ShortFunction.CreateDir(Csadd, "Taken");
                ...
                try {
                    try ( //set party intial balance to party.txt
                            // PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(PRTadd+"/"+scode+"/Pending/Given/"+ShortFunction.NamingDateName(sd)+ ".txt"))) // Detail stord in formate of name \n code \n add \n mob
                            PrintWriter out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(PRTadd + "/" + scode + "/Pending/Given/" + ShortFunction.NamingDateName(sd) + ".txt"), "UTF-8"));) {
                        out.println(sbal);
                        out.println("0000.00");
