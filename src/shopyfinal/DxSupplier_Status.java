 ...
 * @author Suthar
 */
public class DxSupplier_Status extends javax.swing.JFrame {

    String baseadd, logo, user, lang = "English";
    String IDyear = "2020-2020", Syear = "01/01/2020", Eyear = "01/01/2020";

    public DxSupplier_Status(String base, String golo, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
    ...
    private void initComponents() {
        ...
        setTitle("Current Status Of Party");
        setAlwaysOnTop(true);
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        new Supplier_Status(baseadd, logo, sd, IDyear, Syear, Eyear).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DxSupplier_Status.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new NewDxPRTxSTS().setVisible(true);
            }
        });
    }
