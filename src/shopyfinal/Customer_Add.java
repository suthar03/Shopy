...
public class Customer_Add extends javax.swing.JFrame {
    ...
    //##################################################################
    public Customer_Add(String base, String golo, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        if (yon == 0) {//YES    
            ...
            if (ShortFunction.repeatation(CMRadd, "customer.txt", scode) == 0) {
                ...
                ShortFunction.CreateDir(CMRadd, scode);
                ...
                try {
                    try ( //set customer intial balance to customer.txt
                            // PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(CMRadd+"/"+scode+"/Pending/Given/"+ShortFunction.NamingDateName(sd)+ ".txt"))) // Detail stord in formate of name \n code \n add \n mob
                            PrintWriter out = new PrintWriter(new OutputStreamWriter(new FileOutputStream(CMRadd + "/" + scode + "/Pending/Given/" + ShortFunction.NamingDateName(sd) + ".txt"), "UTF-8"));) {
                        out.println(sbal);
                        out.println("0000.00");
