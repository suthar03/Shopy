 ...
 * @author Suthar
 */
public class Item_Status_OnD2D extends javax.swing.JFrame {

    String baseadd, logo, ITMadd, user, dt1, dt2, ndt, lang = "English";
    String IDyear = "2020-2020", Syear = "01/01/2020", Eyear = "01/01/2020", SSyear = "01/01/2020";

    public Item_Status_OnD2D(String base, String golo, String sd1, String sd2, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
        ...
        System.out.println(IDyear + " : " + Syear + " : " + Eyear + " : " + SSyear);
        dt1 = sd1;
        dt2 = sd2;
        ...
        System.out.println(ITMadd);
        initComponents();
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(50, 50, 1015, (int) dim.getHeight() - 50);
    ...
    public void stocker() {
        ...
        try {
            ...
            while (read.hasNext()) // It's for Items ... equals to the number of item
            {
                ...
                String icode, iEname = null, iHname = null, str1 = "00";
                int timee = 0;
                ...
                String dsd;
                for (dsd = ShortFunction.NamingDate(dt1); ShortFunction.DateInBetween(SSyear, dsd, dsd); dsd = ShortFunction.Date_minus(dsd)) {
...
//TextIO.putln(ccode +"  ---> "+CStatus);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Item Status Between Dates");

        dtlbl.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        dtlbl.setForeground(new java.awt.Color(51, 204, 0));
        dtlbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        dtlbl.setText("Date from 10/10/2019 to 10/10/2019");
...
//######################################################################################3
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Item_Status_OnD2D.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Item_Status_OnD2D().setVisible(true);
            }
        });
    }
