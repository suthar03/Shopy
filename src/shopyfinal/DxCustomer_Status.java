 ...
 * @author Suthar
 */
public class DxCustomer_Status extends javax.swing.JFrame {

    String baseadd, logo, user, lang = "English";
    String IDyear = "2020-2020", Syear = "01/01/2020", Eyear = "01/01/2020";

    public DxCustomer_Status(String base, String golo, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
    ...
    private void confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmActionPerformed
        ...
        new Customer_Status(baseadd, logo, sd, IDyear, Syear, Eyear).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DxCustomer_Status.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
