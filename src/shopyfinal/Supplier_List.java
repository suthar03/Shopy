...
public class Supplier_List extends javax.swing.JFrame {
    ...
    public Supplier_List(String base, String golo, String idy, String sy, String ey) {
...
public void lister() {
        ...
        try {
            ...
            while (cd <= maxx) {
                ...
                if (ShortFunction.repeatation(PRTadd, "party.txt", Pacc) == 1) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Supplier_List.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//########################################################################################################
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Supplier_List("D:/Shopy/Shopy", "src/Icons/logo.png", "20210128-20210630", "28/01/2021", "30/06/2021").setVisible(true);
            }
        });
    }
