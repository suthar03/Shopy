...
public class Supplier_Edit extends javax.swing.JFrame {
    ...
    public Supplier_Edit(String base, String golo, String idy, String sy, String ey) {
        baseadd = base;
        logo = golo;
        IDyear = idy;
        Syear = sy;
...
//table.setCellSelectionAllowed(false);
    ...
    public void rep() {
        ...
        if (way.equals("Taken")) {
            ...
            if (ShortFunction.repeatation(PRTadd + "/" + ccode.getText() + STRaddT + "/", ShortFunction.NamingDateName(vtd) + ".txt", COsavedform) == 1 && ShortFunction.repeatation(ITMadd + "/" + icode.getText() + "/Status", ShortFunction.NamingDateName(vtd) + ".txt", IOsavedform) == 1) {
                try {
                    ShortFunction.ReplaceLineEx(PRTadd + "/" + ccode.getText() + STRaddT + "/", ShortFunction.NamingDateName(vtd) + ".txt", COsavedform, CNsavedform, 1);
                    Scanner in;
                    in = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddT + "/" + ShortFunction.NamingDateName(vtd) + ".txt"), "UTF-8");
                    String pd = in.nextLine();
                    Float nd = Float.valueOf(pd) - striAMT + tot;
                    ShortFunction.ReplaceLineWN(PRTadd + "/" + ccode.getText() + STRaddT, ShortFunction.NamingDateName(vtd) + ".txt", 1, String.valueOf(nd));
                    in.close();
                    ...
                    for (dsd = ShortFunction.Date_plus(dsd); ShortFunction.DateInBetween(dsd, dsd, Eyear); dsd = ShortFunction.Date_plus(dsd)) {                               //Updating all file created or having date of early created
                        tmp = new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(dsd) + ".txt");
                        bg = tmp.exists();
                        if (bg) {
                            ...
                            ShortFunction.ReplaceLineWN(PRTadd + "/" + ccode.getText() + STRaddG, ShortFunction.NamingDateName(dsd) + ".txt", 1, String.valueOf(balnc));
                            in.close();
                        }
                    }
            ...
            /* try {
             ...
             Logger.getLogger(Supplier_Edit.class.getName()).log(Level.SEVERE, null, ex);
             }*/

            if (ShortFunction.repeatation(PRTadd + "/" + ccode.getText() + STRaddG + "/", ShortFunction.NamingDateName(vtd) + ".txt", COsavedform) == 1 && ShortFunction.repeatation(ITMadd + "/" + icode.getText() + "/Status", ShortFunction.NamingDateName(vtd) + ".txt", IOsavedform) == 1) {
                try {
                    Scanner in;
                    //if(repeatationWOcase.mainn(PRTadd +"/" + ccode.getText()+ STRaddG,  ShortFunction.NamingDateName(vtd)+".txt", COsavedform)==0&&repeatationWOcase.mainn(ITMadd+"/"+icode.getText()+"/Status", ShortFunction.NamingDateName(vtd)+".txt", IOsavedform)==0)
                    //  System.out.println("You Can ..");
                    ShortFunction.ReplaceLineEx(PRTadd + "/" + ccode.getText() + STRaddG + "/", ShortFunction.NamingDateName(vtd) + ".txt", COsavedform, CNsavedform, 2);//ShortFunction.NamingDateName(vtd)
                    in = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(vtd) + ".txt"), "UTF-8");
                    in.nextLine();
                    String pd = in.nextLine();
                    Float nd = Float.valueOf(pd) - striAMT + tot;
                    System.out.println("Updating Total");
                    ShortFunction.ReplaceLineWN(PRTadd + "/" + ccode.getText() + STRaddG, ShortFunction.NamingDateName(vtd) + ".txt", 2, String.valueOf(nd));//ShortFunction.NamingDateName(vtd)
                    in.close();
                    String dsd = ShortFunction.NamingDate(vtd);
...
//###################################################################################################################################    
    ...
    public void PRTxName() {
        if (ShortFunction.repeatation(PRTadd, "party.txt", ccode.getText()) == 1) {          //Party's account exists or not  ####111
...
//######################################################################################################################################3
    ...
    public void see() {
        ...
        while (ShortFunction.DateInBetween(ShortFunction.NamingDate(dt1), ndt, ShortFunction.NamingDate(dt2))) {
            ...
            String td;
            File tmp = new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(ndt) + ".txt");
            boolean ex = tmp.exists();
            if (ex) {
                //System.out.println(PRTadd+"/"+ccode.getText()+STRaddG+"/"+ShortFunction.NamingDateName(ndt)+".txt");
                try {
                    read = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(ndt) + ".txt"), "UTF-8");
                    read.useDelimiter(",|\\n");
                    read.nextLine();
                    read.nextLine();
                    while (read.hasNext()) {
            ...
            tmp = new File(PRTadd + "/" + ccode.getText() + STRaddT + "/" + ShortFunction.NamingDateName(ndt) + ".txt");
            ex = tmp.exists();
            if (ex) {
                try {
                    read = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddT + "/" + ShortFunction.NamingDateName(ndt) + ".txt"), "UTF-8");
                    read.useDelimiter(",|\\n");
                    read.nextLine();
                    while (read.hasNext()) {
                        td = read.next();
...
//###############################################################################################################################################################3                              
                                    ...
                                    //System.out.println(PRTadd +"/" + ccode.getText()+ STRaddG+"/"+ShortFunction.NamingDateName(vtd)+".txt\n"+Csavedform);
                                    String st1 = vtd + "," + ccode.getText() + ",-" + striqty + "," + strirate + "," + striamt;
                                    String st2 = "," + mode + ",Party";
                                    String Isavedform = st1 + st2;
                                    if (ShortFunction.repeatation(PRTadd + "/" + ccode.getText() + STRaddG, ShortFunction.NamingDateName(vtd) + ".txt", Csavedform) == 1 && ShortFunction.repeatation(ITMadd + "/" + stricode + "/Status", ShortFunction.NamingDateName(vtd) + ".txt", Isavedform) == 1) {
                                        det = true;
                                        ShortFunction.RemoveLineEx(PRTadd + "/" + ccode.getText() + STRaddG, ShortFunction.NamingDateName(vtd) + ".txt", Csavedform, 2);
                                        in = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(vtd) + ".txt"), "UTF-8");
                                        in.nextLine();
                                        String pd = in.nextLine();
                                        ...
                                        for (dsd = ShortFunction.Date_plus(dsd); ShortFunction.DateInBetween(dsd, dsd, Eyear); dsd = ShortFunction.Date_plus(dsd)) {
                                            ...
                                            bg = tmp.exists();
                                            if (bg) {
                                                in = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddG + "/" + ShortFunction.NamingDateName(dsd) + ".txt"), "UTF-8");
                                                pd = in.nextLine();
                                                nd = Float.valueOf(pd) - Float.valueOf(striamt);
                                                ShortFunction.ReplaceLineWN(PRTadd + "/" + ccode.getText() + STRaddG, ShortFunction.NamingDateName(dsd) + ".txt", 1, String.valueOf(nd));
                                                in.close();
                                            }
                                        }
...
//###################################################################################################################################################################
                                    if (ShortFunction.repeatation(PRTadd + "/" + ccode.getText() + STRaddT, ShortFunction.NamingDateName(vtd) + ".txt", Csavedform) == 1) {
                                        det = true;
                                        ShortFunction.RemoveLineEx(PRTadd + "/" + ccode.getText() + STRaddT, ShortFunction.NamingDateName(vtd) + ".txt", Csavedform, 1);
                                        Scanner in;
                                        in = new Scanner(new File(PRTadd + "/" + ccode.getText() + STRaddT + "/" + ShortFunction.NamingDateName(vtd) + ".txt"), "UTF-8");
                                        String pd = in.nextLine();
                                        Float nd = Float.valueOf(pd) - Float.valueOf(striamt);
