...
public class orderbook extends javax.swing.JFrame {
    ...
    public orderbook(String base,String golo,String gh,String idy, String sy,String ey) {
       baseadd=base;
        logo=golo;
        IDyear = idy;
        Syear = sy;
            ...
            while (read.hasNext())                    // It's for Item ... equals to the number of item
{
      ...
      if(fs){
       ...
       fs = tmp.exists();
      if(fs){
          System.out.println(ITMadd+"/"+icode+"/Status/"+NamingDateName.mainn(tdt)+".txt");
